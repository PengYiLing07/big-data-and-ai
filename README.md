...
- **技能定位**：能接收**任意新概念**（不限于本仓库三个），按统一 7 板块结构产出学习资料，并强制遵守“来源可核查、个人理解与权威结论分开、交付前自检”。
...
2. 命中 `description` 后，WorkBuddy 会加载 `SKILL.md`，按其中“7 板块结构 + 联网核查来源 + 自检”的流程执行。
...
| 文件 | 主题 | 核心内容 |
|------|------|---------|
| `learning-materials/agent.html` | AI Agent（智能体） | 个人解释、LLM+工具+指令/记忆+编排循环、订票场景、与聊天机器人的区别 |
...
2. **个人理解在场**：每份资料都有“我的类比 / 我的理解 / 我的核查说明”块，与权威结论明确区分，避免整段照搬 AI 输出。
3. **内容方向核对**：我对 Agent、上下文、Skill 三份资料的核心表述，与多个独立来源交叉比对后采信（详见各页“核查说明”）。
4. **结构自检**：按 Skill 中定义的自检清单核对 7 板块齐全、来源可点、无敏感信息后再提交。
