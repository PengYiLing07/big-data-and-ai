...
它既保存了一个**可复用的「概念学习资料生成 Skill」**，也保存了**由该 Skill 生成、并经人工核查的概念学习资料**。
...
- **技能定位**：能接收**任意新概念**（不限于本仓库三个），按统一 9 板块结构产出学习资料，并强制遵守“来源可核查、辅助说明与权威结论分开、交付前自检”。
...
3. **内容方向核对**：Agent、上下文、Skill 三份资料的核心表述，与多个独立来源交叉比对后采信（详见各页“核查说明”）。
